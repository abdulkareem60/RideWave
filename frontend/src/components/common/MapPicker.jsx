...
// ── Singleton loader — only loads the script once per page ────────────────
...
function loadGoogleMaps() {
  ...
  loaderPromise = new Promise((resolve, reject) => {
    ...
    const cbName = '__gmapsReady_mp_' + Date.now();
    ...
    script.async = true;
    script.onerror = () => { delete window[cbName]; reject(new Error('Failed to load Google Maps script')); };
