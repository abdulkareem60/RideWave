...
export default function TermsPage() {
  return (
    <LegalPageLayout>
      <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-1">Terms of Service</h1>
      ...
      <div className="prose prose-sm max-w-none space-y-6 text-gray-700 dark:text-gray-300">
        ...
        <section>
          <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">2. The Service</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">3. Account Eligibility</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">4. Driver Verification</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">5. Bookings and Payments</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">6. Conduct</h2>
          <p>
        ...
        <section>
          <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-2">8. Changes to These Terms</h2>
          <p>
